package com.nawin.navinsremoteserviceclient;
...
import  com.nawin.navinsremoteservicetutorial.IRemoteFileUpload;
...
public class MainActivity extends AppCompatActivity {
    ...
    private IRemoteFileUpload IRservice;
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            IRservice = IRemoteFileUpload.Stub.asInterface(service);
    ...
    public void connectService() {
        if (IRservice == null) {
            ...
            bindIntent.setClassName("com.nawin.navinsremoteservicetutorial",
                    "com.nawin.navinsremoteservicetutorial"
                            + ".FileUploadRemoteService");
